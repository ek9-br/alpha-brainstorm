...
const actions:[string,SessionStatus][]=[['Iniciar agrupamento','AI_GROUPING'],['Ir para revisão','GROUP_REVIEW'],['Encerrar votação','VOTING_WAITING'],['Publicar resultados','RESULTS'],['Finalizar evento','FINISHED']];
